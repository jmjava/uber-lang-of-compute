...
- [0040 Engine aggregation + CDC remaining work](adr/0040-engine-aggregation-and-cdc.md)
...
| [pureplay-multi-tier-platform.md](explorations/pureplay-multi-tier-platform.md) | PurePlay — Cognito, service-layer mapping, billing, teams, tiered SLA, 3-step pipeline ([share link](https://github.com/jmjava/uber-lang-of-compute/blob/main/docs/explorations/pureplay-multi-tier-platform.md)) |
...
| 37–40 | Unfold coarsen chain, live Kind unfold, Kafka CDC, real Debezium WAL capture (**37–40 verified**) ([ADR 0040](adr/0040-engine-aggregation-and-cdc.md)) |
