...
| [pureplay-multi-tier-platform.md](explorations/pureplay-multi-tier-platform.md) | PurePlay target use case — Cognito login/user mgmt, teams, tiered SLA, 3-step Alex pipeline |
